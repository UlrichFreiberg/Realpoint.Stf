...
// </copyright>
// <summary>
//   Defines the PropertyEnquiry type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Realpoint.Stf.RealpointWeb.Models.PropertySearch
{
    ...
    /// The PropertyEnquiry.
    /// </summary>
    public class PropertyEnquiry : RealpointWebShellModelBase, IPropertyEnquiry
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyEnquiry"/> class.
        /// </summary>
        /// <param name="realpointWebShell">
        /// The realpoint web shell.
        /// </param>
        public PropertyEnquiry(IRealpointWebShell realpointWebShell)
        ...
        public string Name
        {
            get
            {
                var retVal = WebAdapter.GetText(By.Id("dnn2961Name"));
            ...
            set
            {
                WebAdapter.TextboxSetTextById("dnn2961Name", value);
            }
        }
        ...
        public string Message
        {
            ...
            set
            {
                WebAdapter.TextboxSetTextById("dnn2961Message", value);
            }
        }
        ...
        public bool Send()
        {
            var retVal = WebAdapter.ButtonClickById("dnn2961Send");
